...
(function ($) {
    ...
    function generateBarcodeVisualization(ean) {
        ...
        for (var i = 0; i < barCount; i++) {
            ...
            var x = i * 6;
            bars.push('<rect x="' + x + '" y="' + (60 - height) + '" width="' + width + '" height="' + height + '" fill="#323232"/>');
        }
        ...
        $('.product-details').html(
            '<div style="text-align:center; padding: 80px 20px;">' +
                ...
                '<div style="display:flex; gap:12px; justify-content:center; flex-wrap:wrap;">' +
                    '<a href="index.html" style="display:inline-block; background:#0D7377; color:#fff; padding:12px 28px; border-radius:4px; font-size:14px; font-weight:600; text-decoration:none;">Početna</a>' +
                    '<a href="store.html" style="display:inline-block; background:#fff; color:#0D7377; border:2px solid #0D7377; padding:10px 28px; border-radius:4px; font-size:14px; font-weight:600; text-decoration:none;">Pregledaj prodavnicu</a>' +
                '</div>' +
            '</div>'
        );
    }
    ...
    function loadProduct(slug) {
        ...
        var $spinner = $(
            ...
            '<i class="fa fa-spinner fa-spin fa-3x" style="color:#0D7377;"></i>' +
