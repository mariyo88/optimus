...
(function ($) {
    ...
    function renderDetails(product) {
        ...
        document.title = product.name + ' — Mobil Gadget';
        ...
        setMeta('og:title', product.name + ' — Mobil Gadget');
    ...
    function generateBarcodeVisualization(ean) {
        ...
        for (var i = 0; i < barCount; i++) {
            ...
            var x = i * 6;
            bars.push('<rect x="' + x + '" y="' + (60 - height) + '" width="' + width + '" height="' + height + '" fill="#0A0A0A"/>');
        }
        ...
        $('.product-details').html(
            '<div style="text-align:center; padding: 80px 20px;">' +
                ...
                '<div style="display:flex; gap:12px; justify-content:center; flex-wrap:wrap;">' +
                    '<a href="index.html" style="display:inline-block; background:#C8102E; color:#fff; padding:12px 28px; border-radius:4px; font-size:14px; font-weight:600; text-decoration:none;">Početna</a>' +
                    '<a href="store.html" style="display:inline-block; background:#fff; color:#C8102E; border:2px solid #C8102E; padding:10px 28px; border-radius:4px; font-size:14px; font-weight:600; text-decoration:none;">Pregledaj prodavnicu</a>' +
                '</div>' +
            '</div>'
        );
    }
    ...
    function injectProductSchema(product) {
        ...
        var schema = {
            ...
            brand: {
                '@type': 'Brand',
                name: (product.brand && product.brand.name) ? product.brand.name : 'Mobil Gadget'
            }
        };
    ...
    function loadProduct(slug) {
        ...
        var $spinner = $(
            ...
            '<i class="fa fa-spinner fa-spin fa-3x" style="color:#C8102E;"></i>' +
