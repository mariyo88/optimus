...
(function ($) {
    ...
    function renderConfirmation(order) {
        ...
        var html = [
            ...
            '      margin-bottom:20px;',
            '  ">',
            '    <i class="fa fa-check" style="font-size:36px;color:#C8102E;"></i>',
            '  </div>',
            ...
            '    <h3 style="margin:5px 0 0;color:#C8102E;letter-spacing:1px;">' + order.orderNumber + '</h3>',
            '  </div>',
            ...
            '          <td class="text-right"><strong style="color:#C8102E;">' + formatPrice(order.totalPrice) + '</strong></td>',
            '        </tr>',
            '      </tfoot>',
            '    </table>',
            '  </div>',
    ...
    function renderError() {
        $('#confirmation-content').html([
            ...
            '  <i class="fa fa-exclamation-triangle" style="font-size:60px;color:#C8102E;margin-bottom:20px;"></i>',
        ...
        if (!orderId) {
            ...
            if (orderNumber) {
                $('#confirmation-content').html([
                    ...
                    '  <p style="color:#666;">Broj porudžbine: <strong style="color:#C8102E;">' + decodeURIComponent(orderNumber) + '</strong></p>',
