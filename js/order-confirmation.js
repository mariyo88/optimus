...
(function ($) {
    ...
    function renderConfirmation(order) {
        ...
        var html = [
            ...
            '      margin-bottom:20px;',
            '  ">',
            '    <i class="fa fa-check" style="font-size:36px;color:#F05A22;"></i>',
            '  </div>',
            ...
            '    <h3 style="margin:5px 0 0;color:#F05A22;letter-spacing:1px;">' + order.orderNumber + '</h3>',
            '  </div>',
            ...
            '          <td class="text-right"><strong style="color:#F05A22;">' + formatPrice(order.totalPrice) + '</strong></td>',
            '        </tr>',
            '      </tfoot>',
            '    </table>',
            '  </div>',
    ...
    function renderError() {
        $('#confirmation-content').html([
            ...
            '  <i class="fa fa-exclamation-triangle" style="font-size:60px;color:#F05A22;margin-bottom:20px;"></i>',
        ...
        if (!orderId) {
            ...
            if (orderNumber) {
                $('#confirmation-content').html([
                    ...
                    '  <p style="color:#666;">Broj porudžbine: <strong style="color:#F05A22;">' + decodeURIComponent(orderNumber) + '</strong></p>',
