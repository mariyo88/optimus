    ...
    var Cart = {
        ...
        showRemovedItemsNotification: function(productNames) {
            ...
            var $banner = $([
                ...
                '">',
                '  <i class="fa fa-ban" style="color: #C8102E; margin-right: 5px; font-size: 12px;"></i>',
        ...
        showCartModal: function(product, quantity) {
            ...
            var priceHtml = price > 0
                ? '<span style="color:#C8102E;font-weight:700;font-size:16px;">' + formatPrice(price) + '</span>'
                : '';
            ...
            var modalHtml = [
                ...
                '        Ukupno u korpi: <strong style="color:#0A0A0A;">' + cartCount + ' ' + (cartCount === 1 ? 'artikal' : 'artikala') + '</strong>',
                '      </span>',
                '    </div>',
                ...
                '#cart-modal-continue:hover { background:#C8102E !important; color:#fff !important; }',
