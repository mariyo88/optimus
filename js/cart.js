    ...
    var Cart = {
        ...
        showRemovedItemsNotification: function(productNames) {
            ...
            var $banner = $([
                ...
                '">',
                '  <i class="fa fa-ban" style="color: #F05A22; margin-right: 5px; font-size: 12px;"></i>',
        ...
        showCartModal: function(product, quantity) {
            ...
            var priceHtml = price > 0
                ? '<span style="color:#F05A22;font-weight:700;font-size:16px;">' + formatPrice(price) + '</span>'
                : '';
            ...
            var modalHtml = [
                ...
                '    <!-- Product row -->',
                '    <div style="padding:20px;display:flex;gap:16px;align-items:center;border-bottom:1px solid #F4F4F4;">',
                '      <a href="' + productHref + '" style="flex-shrink:0;">',
                '        <img src="' + imgSrc + '" alt="' + productName + '" style="',
                '          width:80px;height:80px;object-fit:contain;',
                '          border:1px solid #eee;border-radius:4px;background:#FFFFFF;">',
                '      </a>',
                ...
                '        Ukupno u korpi: <strong style="color:#1A1A1A;">' + cartCount + ' ' + (cartCount === 1 ? 'artikal' : 'artikala') + '</strong>',
                '      </span>',
                '    </div>',
                ...
                '        border:2px solid #F05A22;background:#fff;',
                '        color:#F05A22;font-size:13px;font-weight:600;',
                ...
                '#cart-modal-continue:hover { background:#F05A22 !important; color:#fff !important; }',
            ...
            if (productId && !isNaN(productId)) {
                ...
                if ($('.cart-dropdown .product-widget').length === 0) {
                    $('.cart-dropdown .cart-list').html(
                        ...
                        '<div style="width:70px;height:70px;margin:0 auto 20px;background:#F4F4F4;border-radius:50%;display:flex;align-items:center;justify-content:center;">' +
