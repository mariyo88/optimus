...
(function ($) {
    ...
    var Wishlist = {
        ...
        showToast: function (message, type) {
            var bgColor = type === 'info' ? '#555' : '#F05A22';
        ...
        showAddedModal: function (product) {
            ...
            var modalHtml = [
                ...
                '        <i class="fa fa-heart" style="color:#F05A22;font-size:18px;"></i>',
                ...
                '        <a href="' + productHref + '" style="color:#1A1A1A;text-decoration:none;',
                ...
                '      <span><i class="fa fa-heart-o" style="margin-right:6px;color:#F05A22;"></i>',
                '        Lista želja: <strong style="color:#1A1A1A;">' + wishCount + ' ' +
                ...
                '        border:2px solid #F05A22;transition:all 0.2s;display:block;">',
                ...
                '#wl-modal-continue:hover{background:#F05A22 !important;color:#fff !important;}',
                '#wl-modal-close:hover{opacity:1 !important;}',
                '.add-to-wishlist.wishlisted i{color:#F05A22;}',
                '</style>'
            ].join('');
