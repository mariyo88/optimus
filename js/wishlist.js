...
(function ($) {
    ...
    var Wishlist = {
        ...
        showToast: function (message, type) {
            var bgColor = type === 'info' ? '#555' : '#0D7377';
        ...
        showAddedModal: function (product) {
            ...
            var modalHtml = [
                ...
                '    <!-- Header -->',
                '    <div style="background:#323232;color:#fff;padding:14px 20px;',
                '      display:flex;align-items:center;justify-content:space-between;">',
                '      <div style="display:flex;align-items:center;gap:10px;">',
                '        <i class="fa fa-heart" style="color:#0D7377;font-size:18px;"></i>',
                ...
                '        <a href="' + productHref + '" style="color:#323232;text-decoration:none;',
                ...
                '      <span><i class="fa fa-heart-o" style="margin-right:6px;color:#0D7377;"></i>',
                '        Lista želja: <strong style="color:#323232;">' + wishCount + ' ' +
                ...
                '        border:2px solid #0D7377;background:#fff;',
                ...
                '        border:2px solid #0D7377;transition:all 0.2s;display:block;">',
                ...
                '#wl-modal-continue:hover{background:#0D7377 !important;color:#fff !important;}',
                '#wl-modal-close:hover{opacity:1 !important;}',
                '.add-to-wishlist.wishlisted i{color:#0D7377;}',
                '</style>'
            ].join('');
